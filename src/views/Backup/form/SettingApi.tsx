...
const SettingForm = (props: any) => {
  ...
  const handleSubmit = async () => {
    if(openApiKey == "") {
        toast.error(t("Open AI Api cannot be empty") as string, { duration: 4000, position: 'top-center' })
    ...
    if(inputModelName == "") {
        toast.error(t("Model Name Api cannot be empty") as string, { duration: 4000, position: 'top-center' })
        setIsDisabledButton(false)
        setUploadingButton(`${t('Submit')}`)
    ...
    if(inputTemperature < 0 || inputTemperature > 1) {
        toast.error(t("Temperature must in the range 0~1") as string, { duration: 4000, position: 'top-center' })
        setIsDisabledButton(false)
        setUploadingButton(`${t('Submit')}`)
