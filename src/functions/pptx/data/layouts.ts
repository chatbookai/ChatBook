...
export const DemoData: any = {
  ...
  "引言": {
    "背景介绍": "随着社会压力的增加，学生心理健康问题日益突出。",
    "研究目的": "探讨有效的心理健康测评方案，以帮助学生更好地应对心理压力。",
    "研究范围": "本方案主要针对中学生群体。"
  },
  "心理健康测评的重要性": {
    "早期发现问题": "及时发现学生的心理问题，有助于早期干预。",
    "促进学生发展": "良好的心理状态有助于学生的全面发展。",
    "提高教育质量": "心理健康测评可以作为提升教育质量的重要工具。"
  },
  "测评工具与方法": {
    "常用工具": "介绍几种常用的心理测评工具，如SCL-、SDQ等。",
    "测评方法": "详细说明如何使用这些工具进行测评。",
    "工具选择依据": "根据不同年龄段和心理问题选择合适的测评工具。"
  },
  "测评流程": {
    "准备阶段": "包括测评工具的选择和测评人员的培训。",
    "实施阶段": "具体描述测评的实施步骤。",
    "数据收集": "详细说明如何收集和记录测评数据。"
  },
  "数据分析与应用": {
    "数据处理": "介绍如何对收集到的数据进行分析。",
    "结果解读": "如何解读测评结果，识别学生的心理问题。",
    "应用建议": "根据测评结果提出针对性的干预措施。"
  },
  "案例分析": {
    "案例选择": "选择几个典型案例进行分析。",
    "案例描述": "详细描述案例的情况和测评结果。",
    "讨论": "对案例进行深入分析，讨论其教育意义。"
  },
  "结论与建议": {
    "研究总结": "总结本方案的实施效果和存在的问题。",
    "改进建议": "提出改进心理健康测评方案的具体建议。",
    "展望": "展望心理健康测评的未来发展方向。"
  },
  "感谢": {
    "演讲人": "我的名字",
