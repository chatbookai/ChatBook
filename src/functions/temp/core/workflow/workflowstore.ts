...
import { FlowNodeTemplateType } from 'src/functions/core/module/type';

const getTeamPlugTemplates = (data: { parentId?: string | null; searchKey?: string }) => { };
const getSystemPlugTemplates = (data: { parentId?: string | null; searchKey?: string }) => { };
